    ...
    function refreshDate(){
        ...
        for(let i=1; i<=totalDate; i++){
            if((i<get_date && get_year===current_date.getFullYear() && get_month===current_date.getMonth()) || get_year<current_date.getFullYear() || (get_year===current_date.getFullYear() && get_month<current_date.getMonth())){
                ...
                setclass = " class='btn green greenbox' value=" + get_year + "年" + month_num[get_month] + "月" + get_date + "日";
                if(i<10){
                    setclass = " class='btn green2 greenbox' value=" + get_year + "年" + month_num[get_month] + "月" + get_date + "日";
                }
            } 
            else{
                setclass = " class='btn darkgrey whitebox' value=" + get_year + "年" + month_num[get_month] + "月" + i + "日";
                if(i<10){
                    setclass = " class='btn darkgrey2 whitebox' value=" + get_year + "年" + month_num[get_month] + "月" + i + "日";
                }
            }
