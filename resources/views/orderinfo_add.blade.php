...
<html lang="en">
    ...
    <body>
        ...
        <header>
            <a href="/restaurant/public/manage/userinfo"><button class="book-h"><div class="word">Booking Restaurant</div></button></a>
            <div class="link">
                ...
                <button type="button" class="btn btn-secondary">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/manage/orderinfo" style="color:#fff;text-decoration:none">取消新增訂單</a>
                </button>         
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Add Order Information</h2>
                    </div>
                    <div class="w3-container5 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/manage/orderinfo_add2" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="mobile2" class="la6"><i class="fa fa-mobile" aria-hidden="true"></i>手機號碼</label><br>
                                    <input type="tel" name="mobile" id="mobile2" required>
                                ...
                                <div class="col-sm-6">
                                <label for="number2" class="la6"><i class="fa fa-users" aria-hidden="true"></i>人數</label>
                                    <input type="text" name="number" id="number2" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <label for="orderid2" class="la6"><i class="fa fa-first-order" aria-hidden="true"></i>訂單編號</label>
                                    <input type="text" name="orderid" id="orderid2" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <label for="date" class="la6"><i class="fa fa-calendar-o" aria-hidden="true"></i>日期</label>
                                    <input type="text" id="date" name="date" for="touch2" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <label for="time2" class="la6"><i class="fa fa-clock-o" aria-hidden="true"></i>時間</label>
                                    <input type="text" id="time2" name="time" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <button id="submit2" type="submit" style="margin-bottom:100px; margin-top:32px"><i class="fa fa-hand-pointer-o" aria-hidden="true" style="padding-right:15px"></i>新增訂單</button>
                                </div>
                            </div>
                            {!! csrf_field() !!}
                        </form>
        ...
        <script src="{{asset('js/calender2.js')}}"></script>
        <script src="{{asset('js/sweetalert2.min.js')}}"></script> 
        @if(session('message')=='successful')
            <script>
                Swal.fire(
                    'Success to add the data',
                    'Success!!',
                    'success'
                )
            </script>
        @elseif(session('message')=='fail')
            <script>
                Swal.fire(
                    'Fail to add the data',
                    'Fail!!',
                    'error'
                )
            </script>
        @elseif(session('message')=='wrong')
            <script>
                Swal.fire(
                    'No such a phone number',
                    'Please check out!!',
                    'error'
                )
            </script>
