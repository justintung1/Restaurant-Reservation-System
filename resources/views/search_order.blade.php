...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="link">
                <button type="button" class="btn btn-success">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/index/search" style="color:#fff;text-decoration:none">回查詢頁</a>
                </button>   
        ...
        <div class="modal fade" id="myModal1{{$data->kn}}" style="z-index:9999">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <button type="button" class="btn btn-primary" style="margin-left:62px">
                            <i class="fa fa-trash" aria-hidden="true" style="margin-right:5px"></i><a href="/restaurant/public/index/del_order/{{$data->kn}}" style="color:#fff;text-decoration:none">Sure!! delete it</a>
                        </button>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach($DATA as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->date}}</td>
                                                    <td>{{$data->time}}</td>
                                                    @if(session('del')==$data->mobile)
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal1{{$data->kn}}">
                                                            Delete
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-warning">
                                                            <a href="/restaurant/public/index/edit_order/{{$data->kn}}" style="color:#fff;text-decoration:none">Edit</a>
                                                        </button>
                                                    </td>
                                                    @endif
                                                    
                                                    <!-- <input type="hidden" value="{{$data->kn}}" id="kn"> -->
                                                </tr>
        ...
        @elseif(session('message')=='delsuccess')
            <script>
                Swal.fire(
                    'Good',
                    'Delete the order successful',
                    'success'
                )
            </script>
        @elseif(session('message')=='delfail')
            <script>
                Swal.fire(
                    'Bad',
                    'Fail to delete the order',
                    'error'
                )
            </script>
        @elseif(session('message')=='goodup')
            <script>
                Swal.fire(
                    'Excellent',
                    'Update the data successful',
                    'success'
                )
            </script>
        @elseif(session('message')=='badup')
            <script>
                Swal.fire(
                    'Try again',
        ...
        <script>
            // $("#knclick").click(function(){
            //     let urll="/restaurant/public/index/del_order/"+$("#kn").val();
            //     alert(urll);
            //     $.ajax({
            //         type:"post",
            //         url:"/restaurant/public/index/del_order/"+$("#kn").val(),
