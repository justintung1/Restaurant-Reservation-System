            ...
            <div class="row">
                ...
                <div class="column middle3">
                    ...
                    <div class="w3-container5 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/manage/login" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="form-group">
                                    <label for="phone" class="la5"><i class="fa fa-address-card-o" aria-hidden="true" style="margin-right:10px;"></i>帳號</label><br>
                                    <input type="tel" id="account2" name="account">
                                </div>
                                <div class="form-group">
                                    <label for="orderid" class="la5"><i class="fa fa-key" aria-hidden="true" style="margin-right:10px;"></i>密碼</label><br>
                                    <input type="password" id="pwd2" name="pwd">
                                </div>
                                <div class="form-group">
                                    <label for="check" class="la5"><i class="fa fa-check-square-o" aria-hidden="true" style="margin-right:10px;"></i>驗證碼:</label><br>
                                    <input type="text" id="check2" placeholder="Enter verifycode" name="check"><br>
                                    <img src="/restaurant/public/manage/verifycode" id="rand-img" class="rand-img" style="margin-left:120px">
                                    <a href="" id="reload-img"><input type="button" value="重新產生" class="btn btn-info"></a>
                                </div>
                                <button type="submit" class="btn btn-primary" id="submit3">登入後端</button>
                            </div>
                            {!! csrf_field() !!}
                        </form>
                    </div>
