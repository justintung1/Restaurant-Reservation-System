        ...
        <header>
            ...
            <div class="link">
                <button type="button" class="btn btn-info">
                    <i class="fa fa-ban" aria-hidden="true"></i><a href="/restaurant/public/index/search3" style="color:#fff;text-decoration:none">取消修改資料</a>
                </button>
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Update Data</h2>
                    </div>
                    <div class="w3-container4 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/index/edit_up" class="needs-validation" novalidate>
                            <div class="row">
                                @foreach($DATA as $data)
                                <div class="col-sm-6">
                                    <label for="number3" class="la6"><i class="fa fa-users" aria-hidden="true"></i>人數</label>
                                    <!-- <input type="text" name="number" id="number3" value="{{$data->number}}" required> -->
                                    <select name="number" id="number3" value="{{$data->number}}">
                                        @foreach($NUM as $num)
                                            @if($num==$data->number)
                                                <option value="{{$data->number}}" selected="on">{{$data->number}}</option>
                                            @else
                                ...
                                <div class="col-sm-6">
                                    <label for="time3" class="la6"><i class="fa fa-clock-o" aria-hidden="true"></i>時間</label>
                                    <!-- <input type="text" id="time3" name="time" value="{{$data->time}}" required> -->
                                    <select name="time" id="time3">
                                        @foreach($TIME as $time)
                                            @if($time==$data->time)
                                                <option value="{{$data->time}}" selected="on">{{$data->time}}</option>
                                            @else
