...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="link">
                <button type="button" class="btn btn-secondary ">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/index" style="color:#fff;text-decoration:none">回首頁</a>
                </button>  
                ...
                <ul id="show" class="list-group">
                    ...
                    @if(session('account'))
                    <li class="list-group-item"><a href="##" style="text-decoration:none">留言專區</a></li>
                    @endif
                ...
                <div class="dropdown beyond5">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-group">
                            ...
                            @if(session('account'))
                            <li class="list-group-item"><a href="##" style="text-decoration:none;font-weight:bold">留言專區</a></li>
                            @endif
            ...
            <div class="row">
                ...
                <div class="column middle2">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Register</h2>
                    </div>
                    <div class="w3-container3 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/index/validating" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <label for="account" class="la2"><i class="fa fa-user-o" aria-hidden="true"></i>帳號名稱</label>
                                    <input type="text" name="account" id="account" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <label for="pwd" class="la2"><i class="fa fa-unlock-alt" aria-hidden="true"></i>密碼</label>
                                    <input type="password" name="pwd" id="pwd" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-6">
                                    <label for="check" class="la2"><i class="fa fa-check" aria-hidden="true"></i>確認密碼</label>
                                ...
                                <div class="col-sm-4">
                                    <button id="submit2" type="submit" style="margin-bottom:100px; margin-top:22px"><i class="fa fa-hand-pointer-o" aria-hidden="true" style="padding-right:15px"></i>註冊</button>
                                </div>
                            </div>
        ...
        @elseif(session('message')=='thesame')
            <script>
                Swal.fire(
                    'Fail!',
