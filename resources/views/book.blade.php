...
<html lang="en">
    ...
    <body>
        ...
        <header>
            <a href="/restaurant/public/index/cancel"><button class="book-h"><div class="word">Booking Restaurant</div></button></a>
            <div class="link">    

                <button type="button" class="btn btn-info ">
                    <i class="fa fa-ban" aria-hidden="true"></i><a href="/restaurant/public/index/cancel" style="color:#fff;text-decoration:none">取消訂位</a>
                </button>
                ...
                <ul id="show" class="list-group">
                    ...
                    <li class="list-group-item"><a href="/restaurant/public/index/search" style="text-decoration:none">訂單查詢</a></li>
                    @if(session('account'))
                ...
                <div class="dropdown beyond5">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-group">
                            <li class="list-group-item"><a href="/restaurant/public/index/cancel" style="text-decoration:none;font-weight:bold">首頁</a></li>
                        ...
                        @foreach($DATA as $data)
                            <div class="media border p-3">
                                <div class="media-body">
                                    <h4>留言者:{{$data->name}} <small><i> 時間:{{$data->date}}</i></small></h4>
                                    <p>{{$data->texting}}</p>      
                                </div>
                            </div><br>
                        @endforeach
            ...
            <div class="row">
                ...
                <div class="column middle2">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Select your time</h2>
                    </div>
                    <div class="w3-container3 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/index/order" class="needs-validation" novalidate id="pick">
                            <div class="row">
                                <div class="col-sm-12">
                                    <hr class="meso">
                                </div>
                                <!-- <div>午餐<hr></div><br> -->
                                <!-- <hr class="meso"><br><br><br> -->
                                <div class="col-sm-3">
                                    <!-- <label class="timing" for="t1" id="tt1">11:00</label>
                                    <input type="radio" name="timer" id="t1" value="one"> -->
                                    <input type="button" name="period" value="11:30" class="timing"> 
                                </div>
                                <div class="col-sm-3">
                                    <!-- <button type="button" class="timing2"><label for="t2" class="timing">11:30</label></button> -->
                                    <!-- <label class="timing" for="t2" id="tt2">11:30</label>-->
                                    <input type="button" name="period" value="12:00" class="timing"> 
                                    <!-- <input type="radio" name="timer" value="two" id="t2"> -->
                                </div>
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="12:30" class="timing">
                                    <!-- <label class="timing" for="t3" id="tt3">12:00</label>
                                    <input type="radio" name="timer" value="three" id="t3"> -->
                                </div>
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="13:00" class="timing">
                                    <!-- <label class="timing" for="t4" id="tt4">12:30</label>
                                    <input type="radio" name="timer" value="four" id="t4"> -->
                                </div><br><br>
                                <!-- <div>晚餐<hr></div><br> -->
                                <!-- <hr class="meso2"><br> -->
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="17:30" class="timing">
                                    <!-- <label class="timing" for="t5" id="tt5">17:30</label>
                                    <input type="radio" name="timer" value="five" id="t5"> -->
                                </div>
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="18:00" class="timing">
                                    <!-- <label class="timing" for="t6" id="tt6">18:00</label>
                                    <input type="radio" name="timer" value="six" id="t6"> -->
                                </div>
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="18:30" class="timing">
                                    <!-- <label class="timing" for="t7" id="tt7">18:30</label>
                                    <input type="radio" name="timer" value="seven" id="t7"> -->
                                </div>
                                <div class="col-sm-3">
                                    <input type="button" name="period" value="19:00" class="timing">
                                    <!-- <label class="timing" for="t8" id="tt8">19:00</label>
                                    <input type="radio" name="timer" value="eight" id="t8"> -->
                                </div>
                                <input type="hidden" name="reservationtime" id="take">
                                <div>
                                    <button id="submit2" type="submit" style="margin-bottom:100px; margin-top:22px"><i class="fa fa-hand-pointer-o" aria-hidden="true" style="padding-right:15px"></i>繼續訂單</button>
                                </div>
                            </div>
                            <!-- <label for="name" class="la2"><i class="fa fa-address-card-o" aria-hidden="true" style="margin-right:6px"></i>姓名</label>
                            <label for="account" class="la3"><i class="fa fa-user-o" aria-hidden="true" style="margin-right:6px"></i>帳號名稱</label>
                            <br>
                            <input type="text" id="name">
                            <input type="text" id="account"><br><br>
                            <label for="pwd" class="la2"><i class="fa fa-unlock-alt" aria-hidden="true" style="margin-right:6px"></i>密碼</label>
                            <label for="check" class="la3"><i class="fa fa-check" aria-hidden="true" style="maring-right:6px"></i>確認密碼</label>
                            <br>
                            <input type="password" id="pwd">
                            <input type="password" id="check"><br><br>
                            <label for="mobile" class="la2"><i class="fa fa-mobile" aria-hidden="true" style="margin-right:6px"></i>電話</label><br>
                            <input type="text" id="mobile"> -->
                            <!-- <label for="date" class="la"><i class="fa fa-calendar-o" aria-hidden="true" style="margin-right:6px"></i>日期</label><br>
                            <input type="text" id="date" name="date" for="touch2">
                            <br><br>
                            <label for="number" class="la"><i class="fa fa-users" aria-hidden="true" style="margin-right:5px;"></i>人數</label><br>
                            ...
                            <label for="phone" class="la"><i class="fa fa-phone" aria-hidden="true" style="margin-right:10px;"></i>電話</label><br>
        ...
        @elseif(session('message')=='notequal')
            <script>
                Swal.fire(
                    'Fail!',
        ...
        @elseif(session('message')=='noinfo')
            <script>
                Swal.fire(
                    'Does not fail in the data',
                    'Try again',
                    'error'
                )
            </script>
        ...
        <script>
            // let v = $("input[name='timer']").is(":checked");
            // if(v){
            ...
            let btns = document.getElementsByClassName("timing");
            let pick = document.getElementById("pick");
            for (let i = 0; i < btns.length; i++) {
                btns[i].addEventListener("click", function() {
                    let pick2 = pick.period[i].value;
                ...
                //console.log(pick2);
                    // if(pick.period[i].className!="active"){
                    //     pick.period[i].className += " active";
                    // }
                    // else{
                    //     let current = document.getElementsByClassName("active");
                    //     current[0].className = current[0].className.replace(" active", "");
            ...
            //         let pick = $("#pick [name='period']")[i].val();
            //         let current = $(".active");
            //         if(current.length>0){
            //             current[0].className = current[0].className.replace(" active","");
            //         }
...
<!-- https://777tv.app/vod/play/id/28145/sid/2/nid/1.html -->