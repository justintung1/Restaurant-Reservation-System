        ...
        <header>
            ...
            <div class="link">
                ...
                <button type="button" class="btn btn-secondary">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/manage/chatinfo" style="color:#fff;text-decoration:none">取消新增留言</a>
                </button>             
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    ...
                    <div class="w3-container5 w3-white w3-padding-16" style="overflow-y:scroll;overflow-x:scroll">
                        <form method="post" action="/restaurant/public/manage/chatinfo_add2" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="name" class="la6"><i class="fa fa-mobile" aria-hidden="true"></i>留言者</label><br>
                                    <input type="tel" name="name" id="name" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="mestime" id="time2" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="comment" class="la6" style="margin-left:35px;"><i class="fa fa-commenting-o" aria-hidden="true"></i>留言內容</label><br>
                                    <textarea class="form-control" rows="5" id="comment" name="text" style="margin-left:35px;margin-top:30px;width:90%" required></textarea>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-12">
                                    <button id="submit2" type="submit" style="margin-bottom:100px; margin-top:32px"><i class="fa fa-hand-pointer-o" aria-hidden="true" style="padding-right:15px"></i>新增留言</button>
                                </div>
                            </div>
                            {!! csrf_field() !!}
                        </form>
