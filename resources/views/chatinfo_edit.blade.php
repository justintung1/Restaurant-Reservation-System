...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="link">
                ...
                <button type="button" class="btn btn-secondary">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/manage/chatinfo" style="color:#fff;text-decoration:none">取消修改</a>
                </button>             
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Chat Information</h2>
                    </div>
                    <div class="w3-container5 w3-white w3-padding-16" style="overflow-y:scroll;overflow-x:scroll">
                        <form method="post" action="/restaurant/public/manage/chatinfo_update" class="needs-validation" novalidate>
                            <div class="row">
                                @foreach($DATA as $data)
                                <div class="col-sm-6">
                                    <label for="name" class="la6"><i class="fa fa-mobile" aria-hidden="true"></i>留言者</label><br>
                                    <input type="tel" name="name" id="name" value="{{$data->name}}" required>
                                ...
                                <div class="col-sm-6">
                                    <label for="time2" class="la6"><i class="fa fa-users" aria-hidden="true"></i>留言時間</label>
                                    <input type="text" name="mestime" id="time2" value="{{$data->date}}" required>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="comment" class="la6" style="margin-left:35px;"><i class="fa fa-commenting-o" aria-hidden="true"></i>留言內容</label><br>
                                    <textarea class="form-control" rows="5" id="comment" name="text" style="margin-left:35px;margin-top:30px;width:90%">{{$data->texting}}</textarea>
                                    <div class="valid-feedback la2">Valid.</div>
                                    <div class="invalid-feedback la2">Please fill out this field.</div>
                                </div>
        ...
        @elseif(session('message')=='successful')
            <script>
                Swal.fire(
                    'Success to change the data',
                    'Success!!',
                    'success'
                )
            </script>
        ...
        @elseif(session('message')=='del')
            <script>
                Swal.fire(
                    'Success to delete the data',
                    'Success!!',
                    'success'
                )
            </script>
        @elseif(session('message')=='del2')
            <script>
                Swal.fire(
                    'Fail to delete the data',
                    'Fail!!',
                    'error'
                )
            </script>
