...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="link">
                <!-- <a href="/restaurant/public/index/login" class="beyond2" style="text-decoration:none">登入<i class="fa fa-user-circle"></i></a> -->
                @if(session('account'))
                    <!-- <button type="button" class="btn btn-secondary">
                        <i class="fa fa-id-badge" aria-hidden="true"></i>歡迎會員
                    </button> -->
        ...
        <div class="modal" id="myModal" style="z-index:9990">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal footer
                    <div>
                        <button type="button" class="btn btn-success" style="margin-left:20px">search</button>
                    </div> -->
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="column middle">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-cutlery w3-margin-right"></i>Booking Restaurant</h2>
                    </div>
                    <div class="w3-container2 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/index/book" class="needs-validation" novalidate>
                            ...
                            <br>
                            <div>
                                <label for="phone" class="la"><i class="fa fa-phone" aria-hidden="true" style="margin-right:10px;"></i>手機號碼</label><br>
                                <input type="tel" id="phone" name="phone" required>
                                <div class="valid-feedback la4">Valid.</div>
                                <div class="invalid-feedback la4">Please fill out this field.</div>
                            </div>
                            <br>
                            <button id="submit" type="submit"><i class="fa fa-search" aria-hidden="true" style="padding-right:15px"></i>訂位</button>
                            {!! csrf_field() !!}
                        </form>
                    </div>
        ...
        <script>
            ...
            //     $.ajax({
            //         type:"POST",
            //         url:"/restaurant/public/index/comment",
            //         data:{chat:comm},
...
<!-- <header class="header-area">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="menu-area d-flex justify-content-between">
                        <!-- Logo Area  
                        <div class="logo-area">
                            <a href="/train/public/index"><b>歡迎蒞臨訂位</b><i style="font-size:32px" class="fa">&#xf239;</i></a>
                        </div>
    ...
    <!-- https://blog.csdn.net/qq_38287952/article/details/77871312 -->
