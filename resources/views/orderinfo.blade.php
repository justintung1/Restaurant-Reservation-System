                ...
                <div class="dropdown beyond5">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><a href="/restaurant/public/manage/orderinfo_add" style="text-decoration:none;font-weight:bold">新增訂單</a></li>
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Order Information
                        <button type="button" class="btn btn-warning" style="position:absolute;margin-left:22px;font-weight:bold;margin-top:4px;">
                            <a href="/restaurant/public/manage/orderinfo_add" style="text-decoration:none">新增訂單</a>
                        </button>
                        </h2>
                    </div>
                    <div class="w3-container5 w3-white w3-padding-16" style="overflow-y:scroll;overflow-x:hidden">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="ui-button ui-widget ui-corner-all">
                                                            <a href="/restaurant/public/manage/orderinfo_edit/{{$data->kn}}" style="text-decoration:none;color:rgb(102, 0, 102);font-weight:bold">修改</a>
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <button class="ui-button ui-widget ui-corner-all">
                                                            <a href="/restaurant/public/manage/orderinfo_del/{{$data->kn}}"  style="text-decoration:none;color:rgb(102, 0, 102);font-weight:bold">刪除</a>
                                                        </button>
                                                    </td>
                                                </tr>
                                            @endforeach
