...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="link">
                ...
                <button type="button" class="btn btn-secondary">
                    <i class="fa fa-undo" aria-hidden="true"></i><a href="/restaurant/public/manage/userinfo" style="color:#fff;text-decoration:none">取消新增會員</a>
                </button>           
            ...
            <div class="row">
                ...
                <div class="column middle3">
                    <div class="w3-container w3-red">
                        <h2><i class="fa fa-sign-in w3-margin-right" aria-hidden="true"></i>Create New User</h2>
                    </div>
                    <div class="w3-container3 w3-white w3-padding-16">
                        <form method="post" action="/restaurant/public/manage/userinfo_add2" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                    <button id="submit2" type="submit" style="margin-bottom:100px; margin-top:22px"><i class="fa fa-hand-pointer-o" aria-hidden="true" style="padding-right:15px"></i>新增會員</button>
                                </div>
                            </div>
                            {!! csrf_field() !!}
                        </form>
        ...
        @elseif(session('message')=='wrong')
            <script>
                Swal.fire(
                    'Same phone number or same account',
                    'Please check out!!',
                    'error'
                )
            </script>
